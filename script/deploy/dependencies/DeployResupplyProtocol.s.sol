...
contract DeployResupplyProtocol is BaseDeploy {
    function deployProtocolContracts() public {
        ...
        bytes memory bytecode = abi.encodePacked(
            vm.getCode("ResupplyPairDeployer.sol:ResupplyPairDeployer"),
            constructorArgs
        );
        ...
        bytecode = abi.encodePacked(
            vm.getCode("InterestRateCalculator.sol:InterestRateCalculator"),
            constructorArgs
        );
        salt = CreateX.SALT_INTEREST_RATE_CALCULATOR;
        predictedAddress = computeCreate3AddressFromSaltPreimage(
            salt,
            deployer,
            true,
            false
        ...
        console.log(
            "InterestRateCalculator deployed at",
        ...
        // ============================================
        constructorArgs = abi.encode("Basic Vault Oracle");
        bytecode = abi.encodePacked(
            vm.getCode("BasicVaultOracle.sol:BasicVaultOracle"),
            constructorArgs
        );
        ...
        // ============================================
        constructorArgs = abi.encode("Underlying Token Oracle");
        bytecode = abi.encodePacked(
            vm.getCode("UnderlyingOracle.sol:UnderlyingOracle"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        bytecode = abi.encodePacked(
            vm.getCode("RedemptionHandler.sol:RedemptionHandler"),
            constructorArgs
        );
        predictedAddress = computeCreate3AddressFromSaltPreimage(
            salt,
    ...
    function deployRewardsContracts() public {
        ...
        bytes memory bytecode = abi.encodePacked(
            vm.getCode("SimpleReceiver.sol:SimpleReceiver"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        console.log(
            "SimpleReceiver implementation deployed at",
        ...
        bytecode = abi.encodePacked(
            vm.getCode("SimpleReceiverFactory.sol:SimpleReceiverFactory"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        console.log(
            "SimpleReceiverFactory deployed at",
        ...
        result = _executeCore(
            ...
            abi.encodeWithSelector(
                SimpleReceiverFactory.deployNewReceiver.selector,
                "Debt Receiver",
                new address[](0)
            )
        );
        ...
        ); // decode the bytes result to an address
        console.log(
            "Insurance Pool Receiver deployed at",
            address(insuranceEmissionsReceiver)
        );
        writeAddressToJson(
            "INSURANCE_POOL_RECEIVER",
            address(insuranceEmissionsReceiver)
        );
        ...
        bytecode = abi.encodePacked(
            vm.getCode("InsurancePool.sol:InsurancePool"),
            constructorArgs
        );
        predictedAddress = computeCreate3AddressFromSaltPreimage(
            salt,
        ...
        bytecode = abi.encodePacked(
            vm.getCode("LiquidationHandler.sol:LiquidationHandler"),
            constructorArgs
        );
        predictedAddress = computeCreate3AddressFromSaltPreimage(
            salt,
        ...
        console.log(
            "Liquidation Handler deployed at",
        ...
        bytecode = abi.encodePacked(
            vm.getCode("SimpleRewardStreamer.sol:SimpleRewardStreamer"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        console.log(
            "IP Emission Stream deployed at",
        ...
        console.log(
            "Pair Emission Stream deployed at",
        ...
        bytecode = abi.encodePacked(
            vm.getCode("FeeDeposit.sol:FeeDeposit"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        bytecode = abi.encodePacked(
            vm.getCode("FeeDepositController.sol:FeeDepositController"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        console.log(
            "FeeDepositController deployed at",
        ...
        bytecode = abi.encodePacked(
            vm.getCode("RewardHandler.sol:RewardHandler"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
        ...
        // =============== Utilities ==================
        // ============================================
        constructorArgs = abi.encode(address(registry));
        bytecode = abi.encodePacked(
            vm.getCode("Utilities.sol:Utilities"),
            constructorArgs
        );
        salt = buildGuardedSalt(
            deployer,
    ...
    function deployLendingPair(
        ...
        require(
            ...
            "ResupplyPairDeployer has no code"
        );
        bytes memory result;
        result = _executeCore(
