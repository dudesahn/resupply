...
contract PairTestSwaps is PairTestBase {
    ...
    */
    function test_leverage() public {
        ...
        (address swappool, , , uint32 swaptype) = Swapper(defaultswapper)
            .swapPools(fraxpath[0], fraxpath[1]);
        ...
        uint256 minout = utilities.getSwapRouteAmountOut(
            toborrow,
            defaultswapper,
            fraxpath
        );
        ...
        fraxresupply.leveragedPosition(
            defaultswapper,
            toborrow,
            10_000e18,
            0,
        ...
        uint256 currentCollateral = fraxresupply.userCollateralBalance(
            address(this)
        );
        minout = utilities.getSwapRouteAmountOut(
            currentCollateral,
            defaultswapper,
            fraxRepayPath
        );
        ...
        fraxresupply.repayWithCollateral(
            defaultswapper,
            currentCollateral,
            minout,
            fraxRepayPath
        ...
        console.log("\ntry leverage...\n");
        curveresupply.leveragedPosition(
            defaultswapper,
            toborrow,
            10_000e18,
            0,
