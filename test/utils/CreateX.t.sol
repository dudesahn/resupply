...
contract CreateXTest is Test {
    ICreateXDeployer public constant createXDeployer =
    ...
    function test_SaltFormat() public {
        ...
        assertEq(
            extractedDeployer,
            deployer,
            "Deployer portion of salt mismatch"
        );
        ...
        assertEq(
            extractedRandomness,
            randomness,
            "Randomness portion of salt mismatch"
        );
    }
}
